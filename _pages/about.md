...
<details style="margin-bottom: 30px; font-size: 0.9em">
  <summary style="cursor: pointer;">Abstract</summary>
  <p style="font-size: 0.9em">
    Over recent decades, the U.S. fruit and vegetable sector has experienced a sharp increase in both the volume and market share of imports, driven by an open domestic import regime and increased competition from low-cost foreign producers. During the same period, there has been a reduction in the production of major fruit and vegetable crops in the U.S. In this paper, I examine the effects of import competition by constructing a county-by-crop-year measure of the competition shock intensity and employing an instrumental variable that leverages export growth of fruit and vegetable crops from U.S. import partners to non-U.S. markets, isolating supply-side variations in foreign competition that are independent of U.S. domestic demand conditions. I address four key questions: How does import competition affect U.S. domestic fruit and vegetable production? What are its effects on producer performance, productivity, and profitability? What are the potential consequences of limiting fruit and vegetable imports on domestic producers? And how do these effects vary across farm size and productivity distributions? The findings aim to inform agricultural trade policy and the resilience of U.S. producers in an increasingly competitive global fruit and vegetable market.
  </p>
</details>
